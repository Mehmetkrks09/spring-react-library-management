...
public class CategoryService {
	...
	public void delete(Long id) {
		...
		if (!categoryRepository.existsById(id)) {
			...
			throw new RuntimeException("ID :" + id + " ile Kategori Bulunamadı");
		}
	...
	public CategoryDTO getByCategoryId(Long id) {
		...
		Category category = categoryRepository.findById(id)
				.orElseThrow(() -> new RuntimeException("Aradığınız " + id + " numaralı KATEGORİ bulunamadı!"));
   ...
   public CategoryDTO updateCategory(Long id, CategoryDTO dto) {
	   ...
	   Category existingCategory = categoryRepository.findById(id)
			   .orElseThrow(()->  new RuntimeException("Güncellenecek Kategori Bulunamadı"+id ));
	   existingCategory.setIsim(dto.getIsim());
